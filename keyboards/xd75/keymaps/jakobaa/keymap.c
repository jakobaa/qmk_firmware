 ...
 */
  ...
  [_COLEMAK] = LAYOUT_ortho_5x15( /* Colemak */
    ...
    KC_LCTL, KC_LGUI, MO(_FN), KC_LALT, TogLR,   KC_ENT,  KC_SPC,  TogRS,   KC_RALT, KC_RGUI, KC_MENU, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
 ...
 */
  ...
  [_LOWER] = LAYOUT_ortho_5x15(/* FUNCTION */
   ...
   _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_QUOT, KC_DQUO, KC_NUHS, KC_NUBS, _______, _______, _______, _______,
  ...
  [_RAISE] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_COLN, KC_SCLN, KC_BSLS, _______, _______, _______,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______, _______, _______, _______,
